...
export class Tag {
    ...
    static readonly DOTNET = new Tag('.NET', '#512bd4');
    static readonly CQRS = new Tag('CQRS', '#3271a8');
    static readonly MEDIATR = new Tag('MediatR', '#7c3aed');
    static readonly AZURE = new Tag('Azure', '#0078d4');
    static readonly JWT = new Tag('JWT', '#ef4444');
    static readonly IDENTITY = new Tag('Identity', '#2563eb');
    static readonly AUTH = new Tag('Auth', '#14b8a6');
    static readonly RENDER = new Tag('Render', '#3b82f6');
